...
public class Investor extends User {
    ...
    public static void showInvestmentDetails() {
        if (fundRecordsList.isEmpty()) {
            System.out.println("No investment records available.");
        } else {
            System.out.println("Investment Records:");
            for (FundRecord record : fundRecordsList) {
                System.out.printf("Date: %s, Funds: %s\n", record.getDate(), record.getFunds());
            }
        }
    }
